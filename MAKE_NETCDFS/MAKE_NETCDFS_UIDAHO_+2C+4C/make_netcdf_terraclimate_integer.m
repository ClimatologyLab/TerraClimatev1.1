...
function []=make_netcdf_terraclimate_integer(varname,year,scenario);
outputDir = '';
gridFilename = '';
...
VERSION = 'v1.1';
	...
	if(strcmp(scenario,'cf'));
   	     inputDir=['/data/obs/obs/gridded/terraclim/MAT/CHANGES_V1.1/COUNTERFACTUAL/'];
	else;
   	     inputDir=['/data/obs/obs/gridded/terraclim/MAT/CHANGES_V1.1/',scenario,'/'];
	end;
        outputDir='/data/obs/obs/gridded/terraclim/NETCDF/FOR_UIDAHO/';
	filename_location='/data/obs/obs/gridded/terraclim/MAT/MONTHLY_V1.1/lonlatel.mat';
        yrRef=1900;
	...
	if(strcmp(intFormat,'int32'));
        ...
        %    DATA 
        %================================
        filename=[varname_infilename,'_',scenario,'_',num2str(year),'.mat'];
	...
	%N_LAT = 4320;
        ...
        %================================
	if(strcmp(scenario,'cf'));
		FULLFILENAME=[outputDir,methodName,'_counterfactual_',varname,'_',num2str(year),'.nc'];
	else;
		FULLFILENAME=[outputDir,methodName,'_plus',scenario,'_',varname,'_',num2str(year),'.nc'];
	end;
