...
myFile='http://thredds.northwestknowledge.net:8080/thredds/dodsC/TERRACLIMATE_ALL/summaries/TerraClimate19912020_tmax.nc';
...
varname = 'tmax';
units = 'deg C';
FULLFILENAME = ['TerraClimate1_',varname,'_monthlyClimatologies_19912020.nc'];
